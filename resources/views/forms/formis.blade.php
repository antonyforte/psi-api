        ...
        <div class="row-span-5">
            ...
            <div class="slider-container">
                ...
                <div class="custom-range-container">
                    ...
                    <input type="range" name="relacaoTerapeuta" class="custom-range-input form-range" id="customRange1" min="0" max="100" step="5">
            ...
            <div class="slider-container">
                ...
                <div class="custom-range-container">
                    ...
                    <input type="range" name="metasTemas" class="custom-range-input form-range" id="customRange2" min="0" max="100" step="5">
                    <div class="custom-range-text-right">
            ...
            <div class="slider-container">
                ...
                <div class="custom-range-container">
                    ...
                    <input type="range" name="metodoForma" class="custom-range-input form-range" id="customRange3" min="0" max="100" step="5">
                    <div class="custom-range-text-right">
            ...
            <div class="slider-container">
                ...
                <div class="custom-range-container">
                    ...
                    <input type="range" name="sessaoGlobal" class="custom-range-input form-range" id="customRange4" min="0" max="100" step="5">
                    <div class="custom-range-text-right">
