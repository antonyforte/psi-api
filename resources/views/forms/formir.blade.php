    ...
    <div class="row-span-3">
        ...
        <div class="row-span-4">
            ...
            <div class="custom-range-container">
                ...
                <input type="range" name="individualmente" class="custom-range-input form-range" id="customRange1" min="0" max="100" step="5">
            </div>
            ...
            <div class="custom-range-container">
                ...
                <input type="range" name="outrasPessoas" class="custom-range-input form-range" id="customRange2" min="0" max="100" step="5">
            </div>
            ...
            <div class="custom-range-container">
                ...
                <input type="range" name="socialmente" class="custom-range-input form-range" id="customRange3" min="0" max="100" step="5">
            </div>
            ...
            <div class="custom-range-container">
                ...
                <input type="range" name="resultadoGlobal" class="custom-range-input form-range" id="customRange4" min="0" max="100" step="5">
            </div>
        </div>
